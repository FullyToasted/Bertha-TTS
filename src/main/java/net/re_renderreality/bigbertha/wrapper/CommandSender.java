package net.re_renderreality.bigbertha.wrapper;
...
public final class CommandSender {	
	...
	public void sendChatComponent(ITextComponent component) {
		this.sender.addChatMessage(component);	
	}
	...
	public void sendLangfileMessage(String langFileEntry, Object... formatArgs) {
		String text = LanguageManager.translate(Reference.getCurrentLang(this.sender), langFileEntry, formatArgs);
