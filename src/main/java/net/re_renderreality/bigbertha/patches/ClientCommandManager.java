package net.re_renderreality.bigbertha.patches;
...
import net.re_renderreality.bigbertha.utils.ClientPlayerSettings;
import net.re_renderreality.bigbertha.utils.PlayerSettings;
import net.re_renderreality.bigbertha.utils.Reference;
import net.re_renderreality.bigbertha.utils.Variables;
...
public class ClientCommandManager extends ClientCommandHandler {
    ...
    public int executeCommand(ICommandSender sender, String message)
    {
        ...
        if (net.re_renderreality.bigbertha.utils.GlobalSettings.enablePlayerVars) {
        ...
        try
        {
            ...
            if (!unresolvedVars.isEmpty()) {
            	TextComponentString text = new TextComponentString(net.re_renderreality.bigbertha.utils.LanguageManager.translate(Reference.getCurrentLang(sender), "command.var.cantBeResolved", unresolvedVars.toString()));
            ...
            if (icommand.checkPermission(this.getServer(), sender)) {
                ...
                if (MinecraftForge.EVENT_BUS.post(event))
                {
                    ...
                    if (icommand instanceof net.re_renderreality.bigbertha.utils.DummyCommand) return 1;
