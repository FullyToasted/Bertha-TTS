...
public class JsonSettingsManager extends SettingsManager {
	...
	public synchronized void loadSettings() {
		...
		catch (IOException ex) {Reference.logger.info("Error reading command config"); this.failed = true;}
		catch (JsonIOException ex) {Reference.logger.info("Error reading command config"); this.failed = true;}
		catch (JsonSyntaxException ex)  {Reference.logger.info("Invalid syntax in command config file: " + ex.getMessage()); this.failed = true;}
	...
	public synchronized void saveSettings() {
		...
		if (this.failed) {
			Reference.logger.info("Command Config won't be saved, because reading failed");
			return;
		}
		...
		catch (IOException ex) {Reference.logger.info("Error saving command config");}
