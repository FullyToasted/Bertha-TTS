...
import net.re_renderreality.bigbertha.core.AppliedPatches;
import net.re_renderreality.bigbertha.core.AppliedPatches.PlayerPatches;
import net.re_renderreality.bigbertha.patches.ClientCommandManager;
import net.re_renderreality.bigbertha.patches.EntityPlayerMP;
import net.re_renderreality.bigbertha.patches.EntityPlayerSP;
import net.re_renderreality.bigbertha.patches.RenderGlobal;
